...
class MonthMilesViewController: UIViewController, ChartDelegate,  UITableViewDataSource, UITableViewDelegate {
    ...
    func postMilesToProgress(){
        ...
        if RowArray.count > 0 {
            ...
            while (i < 5)
            {
                ...
                {
                    milesArray.append(Int(RowArray[i][j]))
                    j = j + 1
                }
        ...
        milesArray = milesArray.reverse()
        
        while (milesArray.count < logDate.count)
        {
            milesArray.append(milesArray[milesArray.count - 1])
        }
        ...
        while(i >= 0)
        {
            ...
            let newPost = ["caloriesIn": caloriesIn[i], "caloriesOut":caloriesOut[i],"logDate":logDate[i],"miles":milesArray[i],"steps":steps[i],"userId":userId,"weight":currentWeight[i]]
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell: MonthMilesTableViewCell = tableView.dequeueReusableCellWithIdentifier("CellIdentifier1") as! MonthMilesTableViewCell
    ...
    func prepareTableData()
    {
        ...
        for i in 0 ..< TableArray1.count
        {
            if(count < 7)
            {
                ...
                TableArray1[i] =   TableArray1[i]/2112
        ...
        for i in 0 ..< RowArray.count
        {
            ...
            numberFormatter.maximumFractionDigits = 1
            if i == 0            {
                SectionArray.append("This Week - " + numberFormatter.stringFromNumber(Double(summedArray[RowArray.count - 1 ]))! + " Miles" )
            }
            if i == 1
            {
                SectionArray.append("1 Week Ago - " + numberFormatter.stringFromNumber(Double(summedArray[RowArray.count - 2]))! + " Miles")
            }
            else if i != 0 && i != 1 {
                SectionArray.append(String( i) + " Weeks Ago - " + numberFormatter.stringFromNumber(Double(summedArray[RowArray.count - 1 - i]))! + " Miles")
            }
        }
    }
